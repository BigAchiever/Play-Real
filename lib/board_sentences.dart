List<String> boardSentences = [
  ...
  "Tell a truth about yourself that no one knows.",
  "Open your phone gallery and show your recent 5 photos to everyone.",
  "Thumb wrestle with the player on your left and Win.",
  "play red hand game with the player on your right and Win.",
  ...
  "Arm wrestle with the player on your right and Win.",
  "pun your tow fingers in your nose and let others record it.",
  "Lick the wall and other can record it.",
  "Arm wrestle with all the players and Win.",
